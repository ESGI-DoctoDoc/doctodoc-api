...
import fr.esgi.doctodocapi.domain.entities.appointment.exceptions.CannotBookAppointmentException;
...
import fr.esgi.doctodocapi.domain.entities.vo.hours_range.HoursRange;
...
import static fr.esgi.doctodocapi.domain.entities.appointment.AppointmentsAvailabilityService.LOCKED_MAX_TIME_IN_MINUTE;
