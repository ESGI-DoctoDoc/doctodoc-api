...
public class ResetPassword {
    ...
    public RequestResetPasswordResponse requestResetPassword(ResetPasswordRequest request) {
        try {
            ...
            throw new AuthenticationException(AuthentificationMessageException.RESET_PASSWORD_ERROR);
        }
    }
    ...
    public UpdatePasswordResponse updatePassword(UpdatePasswordRequest request) {
        try {
            ...
            if (!"RESET_PASSWORD".equals(role)) {
                throw new AuthenticationException(AuthentificationMessageException.INVALID_TOKEN);
            }
