...
public class JwtService implements TokenManager {
    ...
    public String generate(String username, String role, Integer expirationInMinutes) {
        ...
        return Jwts.builder()
                ...
                .expiration(new Date(System.currentTimeMillis() + expirationInMinutes * 60 * 1000))
                .and()
                .signWith(getKey())
                .compact();
