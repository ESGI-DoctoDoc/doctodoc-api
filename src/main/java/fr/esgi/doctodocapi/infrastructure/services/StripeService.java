...
public class StripeService {
    ...
    public String upsertCustomer(Doctor doctor) throws StripeException {
        if (doctor.getStripeCustomerId() != null) {
            return doctor.getStripeCustomerId();
        }
    ...
    public Session createCheckoutSession(String customerId, String successUrl, String cancelUrl) throws StripeException {
    ...
    public void updateSubscriptionToCancelIt(String subscriptionId) throws StripeException {
    ...
    public BigDecimal getAmountPaid(String sessionId) throws StripeException {
