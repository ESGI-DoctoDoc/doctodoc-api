...
import fr.esgi.doctodocapi.domain.use_cases.user.authentication.AuthenticatePatient;
import fr.esgi.doctodocapi.domain.use_cases.user.manage_account.ResetPassword;
